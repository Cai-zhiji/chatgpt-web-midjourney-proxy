...
app.listen(6003, () => globalThis.console.log('Server is running on port 3002'))
// app.listen(3002, '0.0.0.0', () => globalThis.console.log('Server is running on port 3002, accessible from any IP'));
