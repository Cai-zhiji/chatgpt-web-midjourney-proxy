...
import {
  NAutoComplete, NButton, NDropdown, NImage, NInput, NModal, NTooltip, useMessage,
} from 'naive-ui'
...
<template>
  <VueTurnstile v-if="homeStore.myData.session.turnstile" ref="tRef" v-model="homeStore.myData.vtoken" :site-key="homeStore.myData.session.turnstile" :appearance="appearance" />
